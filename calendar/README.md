...
![Внешний вид компонента](../resources/calendar-preview.png)
...
При необходимости можете воспользоваться библиотекой Moment.js ( **day.js** ), установив её через npm, не забудьте, что это не dev-зависимость.
